...
// import {ApexCharts} from '@/modules/core/libs/apexcharts';
// import { tabler } from '@/modules/core/libs/tabler';
// import { jsVectorMap } from '@/modules/core/libs/jsVectorMap'
...
onMounted(() => {
  tabler = window.tabler;
  jsVectorMap = window.jsVectorMap;
