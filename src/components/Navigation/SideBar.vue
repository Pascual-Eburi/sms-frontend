    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="sidebar-menu">
        <ul class="navbar-nav pt-lg-3">
          ...
          <SectionTitle title="Academic Area" />
          <li class="nav-item">
            <router-link class="nav-link" to="/students">
              <span class="nav-link-icon d-md-none d-lg-inline-block">
                <PhStudent :size="32" weight="duotone" />
              </span>
          ...
          <li class="nav-item">
            <router-link class="nav-link" to="/teachers">
              <span class="nav-link-icon d-md-none d-lg-inline-block">
                <PhChalkboardTeacher :size="32" weight="duotone" />
              </span>
              <span class="nav-link-title"> Profesores </span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link class="nav-link" to="/subjects">
              <span class="nav-link-icon d-md-none d-lg-inline-block">
                <PhBooks :size="32" weight="duotone" />
              </span>
              <span class="nav-link-title"> Asignaturas </span>
            </router-link>
          </li>
          <SectionTitle title="Academic Area" />
          <li class="nav-item">
            <router-link class="nav-link" to="/courses">
              <span class="nav-link-icon d-md-none d-lg-inline-block">
                <PhGraduationCap :size="32" weight="duotone" />
              </span>
          ...
          <li class="nav-item">
            <router-link class="nav-link" to="/attendance">
              <span class="nav-link-icon d-md-none d-lg-inline-block">
                <PhClockUser :size="32" weight="duotone" />
              </span>
          ...
          <li class="nav-item">
            <a class="nav-link" href="./icons.html">
              ...
              <span class="nav-link-title"> 5844 icons </span>
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="./illustrations.html">
              ...
              <span class="nav-link-title"> Illustrations </span>
            </a>
          </li>
          <li class="nav-item dropdown">
            <a
...
<script setup>
import { PhHouse, PhStudent, PhChalkboardTeacher, PhBooks, PhGraduationCap, PhClockUser } from '@phosphor-icons/vue'
import SectionTitle from '@components/UI/Navigation/SectionTitle.vue'
import { onMounted } from 'vue'
import initDropdowns from '@/utils/UI/initDropdowns.js'
